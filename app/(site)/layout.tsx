    ...
    <html suppressHydrationWarning lang="en">
      ...
      >
        ...
        >
          ...
          <div className="fixed inset-0 -z-50 bg-gradient-to-br from-blue-200 via-white to-pink-100 dark:bg-gradient-to-br dark:from-slate-950 dark:via-gray-900 dark:to-blue-950 transition-colors duration-300" />
                ...
                <div className="col-span-1 md:col-span-1">
                  <div className="flex flex-col items-center md:items-start">
                    ...
                    <p className="text-sm text-gray-300 text-center md:text-left">
                      A vibrant community of innovators, learners, and future
                      leaders.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-span-1">
                  ...
                  <div className="space-y-2 text-center md:text-left">
                    ...
                    <div className="flex space-x-3 justify-center md:justify-start pt-2">
                      <a
                        href="https://www.facebook.com/profile.php?id=100080345752240"
                        target="_blank"
