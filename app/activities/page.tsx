  ...
  const upcomingEvents = [
    {
      ...
      description: "A premier lighting conference focusing on advancements in lighting technology, energy efficiency, and emerging applications.",
      status: "Coming Soon"
    },
    {
      title: "IEEEXtreme",
      ...
      image: "/images/events/ieeextreme-placeholder.jpg",
      description: "A 24-hour global programming competition bringing together students from around the world to solve real-world coding challenges.",
      status: "Coming Soon"
    },
    {
      title: "IEEE Day",
      date: "October 1, 2025",
      location: "ISTIC Borj Cedria",
      image: "/images/events/ieee-day-placeholder.jpg",
      description: "Celebrating the first time IEEE members gathered to share their technical ideas in 1884 with special activities and networking.",
      status: "Coming Soon"
    },
    {
      title: "TSYP (Tunisian Students & Young Professionals)",
      date: "December 12-14, 2025",
      location: "Tunis, Tunisia",
      image: "/images/events/tsyp-placeholder.jpg",
      description: "A national congress bringing together students and young professionals to discuss innovation, leadership and career opportunities.",
      status: "Coming Soon"
    }
  ];
  ...
  const pastEvents = [
    {
      ...
      location: "ISTIC Borj Cedria",
      image: "/images/events/ideathon-placeholder.jpg",
      description: "A collaborative event with the University of Aizu where students developed innovative solutions to real-world problems."
    },
    {
      title: "STMicroelectronics Industrial Visit",
      date: "February 15, 2025",
      location: "STMicroelectronics, Tunis",
      image: "/images/events/st-micro-placeholder.jpg",
      description: "An exclusive industrial visit providing hands-on experience with cutting-edge semiconductor manufacturing technologies."
    },
    {
      title: "Symphony: NVIDIA Bootcamp",
      date: "January 20-22, 2025",
      location: "Online & ISTIC Borj Cedria",
      image: "/images/events/nvidia-placeholder.jpg",
      description: "A hybrid event featuring online sessions by Hamza Mellouli and onsite deep learning workshops by Ghassen."
    },
    {
      title: "SHE Secured",
      date: "December 5, 2024",
      location: "ISTIC Borj Cedria",
      image: "/images/events/she-secured-placeholder.jpg",
      description: "An empowering cybersecurity workshop focused on increasing women's participation in information security fields."
    }
  ];
      ...
      <section className="container mx-auto py-12">
        <div className="flex flex-col items-center">
          ...
          <div className="text-center mb-12">
            ...
            <div className="mt-10 text-xl max-w-3xl mx-auto text-gray-700 dark:text-gray-300">
              <p className="leading-relaxed">
                IEEE ISTIC SB hosts a variety of events and activities throughout the year. 
                From technical workshops to networking opportunities, there's something for everyone.
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 w-full max-w-7xl px-6">
            <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-2xl p-8 md:p-12 text-center text-white">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Want to participate?</h2>
              <p className="text-xl mb-8 max-w-3xl mx-auto">
                Join our community and be part of our exciting events. Stay updated with the latest activities and opportunities.
              </p>
              <a 
                href="https://www.ieee.org/membership/join/index.html" 
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center bg-white text-blue-600 font-bold py-3 px-8 rounded-xl hover:bg-blue-50 hover:scale-105 transition-all duration-300"
              >
                <span>Join IEEE ISTIC SB</span>
