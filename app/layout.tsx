                ...
                <div className="col-span-1">
                  ...
                  <div className="space-y-2 text-center md:text-left">
                    ...
                    <div className="flex space-x-3 justify-center md:justify-start pt-2">
                      <a href="https://www.facebook.com/profile.php?id=100080345752240" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition">
                      ...
                      <a href="https://www.instagram.com/ieee.istic.sb" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition">
